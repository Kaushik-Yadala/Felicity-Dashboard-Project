  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      ...
      try {
        ...
        const response = await apiClient.get("/auth/participant");
        ...
        <div className="max-w-full mx-auto px-6 py-4">
          <NavigationMenu className="w-full mx-auto flex justify-center">
            <NavigationMenuList className="flex items-center justify-center gap-8">
              ...
              <NavigationMenuItem>
                <NavigationMenuLink className="px-3 py-2 font-medium hover:text-primary transition-colors cursor-pointer" asChild>
                    <Link href="/participant/events">Browse Events</Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
              
              <NavigationMenuItem>
                <NavigationMenuLink className="px-3 py-2 font-medium hover:text-primary transition-colors cursor-pointer" asChild>
                    <Link href="/participant/organizers">Browse Organizers</Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
